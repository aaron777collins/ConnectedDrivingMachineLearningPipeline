...
from DataCleanerPosConstOffset import DataCleanerPosConstOffset
...
class ModelTrainerMLPosOffsetConstSCSortedByTime:
    ...
    def main(self):
        ...
        groundTruthData = DataGatherer.gatherData(DataPath, "traceGroundTruthJSON-7.json", DataCleanerPosConstOffset.REFINED_DATA_PATH, DataGatherer.RAW_FILE_NAME)
